...
// Declare mocks spec
const mocks = require('./currency.mocks');
...
// Run testing
describe('Testing Endpoint /currency', async () => {
  /*  Testing method Create
   *  URI: /currency
   *  Method: POST
   */
  mocks.forEach(async (row) => {
    await test(`Testing ${getCounter()} - Method /currency (POST) [currency.create]`, async () => {
      counter += 1;
      await request().post('/currency').send(row)
        .then((response) => {
          if (response.statusCode === 201) {
            expect(response.body).toBeDefined();
            expect(response.body.active).toEqual(row.active);
            expect(response.body.code).toBeDefined();
            expect(response.body.code.alphabetic).toEqual(row.code.alphabetic);
            expect(response.body.code.numeric).toEqual(row.code.numeric);
            expect(response.body.decimal).toEqual(row.decimal);
   ...
   */
  mocks.forEach(async (row) => {
    await test(`Testing ${getCounter()} - Method /currency/:id (GET) [currency.view]`, async () => {
      await request().get(`/currency/${row._id}`)
        .then((response) => {
   ...
   */
  mocks.forEach(async (row) => {
    await test(`Testing ${getCounter()} - Method /currency/:id (PUT) [currency.update]`, async () => {
      const data = row;
      data.name += ' - Update';
      await request().put(`/currency/${row._id}`).send(data)
        .then((response) => {
          if (response.statusCode === 200) {
            expect(response.body).toBeDefined();
            expect(response.body.active).toEqual(row.active);
   ...
   */
  mocks.forEach(async (row) => {
    await test(`Testing ${getCounter()} - Method /currency/:id (DELETE) [currency.remove]`, async () => {
      await request().delete(`/currency/${row._id}`)
        .then((response) => {
          if (response.statusCode === 200) {
            expect(response.body).toBeDefined();
            expect(response.body.active).toEqual(row.active);
   ...
   *  Method: GET
   */
  test(`Testing ${getCounter()} - Method /currency (LIST) [currency.list]`, async () => {
    await request().get('/currency?limit=3&page=1&order=desc&logs=d,t')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
  ...
  test(`Testing ${getCounter()} - Method /currency (LIST) [currency.list]`, async () => {
    await request().get('/currency?limit=5&page=2&order=asc&logs=c,d,t')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
  ...
  test(`Testing ${getCounter()} - Method /currency (LIST) [currency.list]`, async () => {
    await request().get('/currency?short&limit=5&order=asc&logs=a,d,t')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
  ...
  test(`Testing ${getCounter()} - Method /currency (LIST) [currency.list]`, async () => {
    await request().get('/currency?short&order=asc')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
  ...
  test(`Testing ${getCounter()} - Method /currency (LIST) [currency.list]`, async () => {
    await request().get('/currency?limit=-1&page=-1&order=asc')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
          expect(response.body.paging.count).toBeDefined();
   ...
   *  Method: GET
   */
  test(`Testing ${getCounter()} - Method /currency/search (SEARCH) [currency.search]`, async () => {
    await request().get('/currency/search?text=Name&limit=3&page=1&logs=d,t')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
          expect(response.body.paging.count).toEqual(3);
  ...
  test(`Testing ${getCounter()} - Method /currency/search (SEARCH) [currency.search]`, async () => {
    await request().get('/currency/search?limit=-1&page=-1&logs=d,t')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
          expect(response.body.paging.count).toEqual(0);
  ...
  test(`Testing ${getCounter()} - Method /currency/search (SEARCH) [currency.search]`, async () => {
    await request().get('/currency/search?text=Name&limit=4&logs=a,d,t')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
  ...
  test(`Testing ${getCounter()} - Method /currency/search (SEARCH) [currency.search]`, async () => {
    await request().get('/currency/search?text=Name 01')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
          expect(response.body.paging.count).toBeDefined();
  ...
  test(`Testing ${getCounter()} - Method /currency/search (SEARCH) [currency.search]`, async () => {
    await request().get('/currency/search?text=01&logs=c,d,t')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
          expect(response.body.paging.count).toBeDefined();
