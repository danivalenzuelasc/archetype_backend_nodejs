...
// Declare mocks spec
const mocks = require('./phone.mocks');
...
// Run testing
describe('Testing Endpoint /phone', async () => {
  /*  Testing method Create
   *  URI: /phone
   *  Method: POST
   */
  mocks.forEach(async (row) => {
    await test(`Testing ${getCounter()} - Method /phone (POST) [phone.create]`, async () => {
      counter += 1;
      await request().post('/phone').send(row)
        .then((response) => {
          if (response.statusCode === 201) {
            expect(response.body).toBeDefined();
            expect(response.body.active).toEqual(row.active);
            expect(response.body.annex).toEqual(row.annex);
            expect(response.body.area).toEqual(row.area);
            expect(response.body.country_code).toEqual(row.country_code);
   ...
   */
  mocks.forEach(async (row) => {
    await test(`Testing ${getCounter()} - Method /phone/:id (GET) [phone.view]`, async () => {
      await request().get(`/phone/${row._id}`)
        .then((response) => {
   ...
   */
  mocks.forEach(async (row) => {
    await test(`Testing ${getCounter()} - Method /phone/:id (PUT) [phone.update]`, async () => {
      const data = row;
      data.number += ' - Update';
      await request().put(`/phone/${row._id}`).send(data)
        .then((response) => {
          if (response.statusCode === 200) {
            expect(response.body).toBeDefined();
            expect(response.body.active).toEqual(row.active);
   ...
   */
  mocks.forEach(async (row) => {
    await test(`Testing ${getCounter()} - Method /phone/:id (DELETE) [phone.remove]`, async () => {
      await request().delete(`/phone/${row._id}`)
        .then((response) => {
          if (response.statusCode === 200) {
            expect(response.body).toBeDefined();
            expect(response.body.active).toEqual(row.active);
   ...
   *  Method: GET
   */
  test(`Testing ${getCounter()} - Method /phone (LIST) [phone.list]`, async () => {
    await request().get('/phone?limit=3&page=1&order=desc&logs=d,t')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
  ...
  test(`Testing ${getCounter()} - Method /phone (LIST) [phone.list]`, async () => {
    await request().get('/phone?limit=5&page=2&order=asc&logs=c,d,t')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
  ...
  test(`Testing ${getCounter()} - Method /phone (LIST) [phone.list]`, async () => {
    await request().get('/phone?short&limit=5&order=asc&logs=a,d,t')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
  ...
  test(`Testing ${getCounter()} - Method /phone (LIST) [phone.list]`, async () => {
    await request().get('/phone?short&order=asc')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
  ...
  test(`Testing ${getCounter()} - Method /phone (LIST) [phone.list]`, async () => {
    await request().get('/phone?limit=-1&page=-1&order=asc')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
          expect(response.body.paging.count).toBeDefined();
   ...
   *  Method: GET
   */
  test(`Testing ${getCounter()} - Method /phone/search (SEARCH) [phone.search]`, async () => {
    await request().get('/phone/search?text=Number&limit=3&page=1&logs=d,t')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
          expect(response.body.paging.count).toEqual(3);
  ...
  test(`Testing ${getCounter()} - Method /phone/search (SEARCH) [phone.search]`, async () => {
    await request().get('/phone/search?limit=-1&page=-1&logs=d,t')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
          expect(response.body.paging.count).toEqual(0);
  ...
  test(`Testing ${getCounter()} - Method /phone/search (SEARCH) [phone.search]`, async () => {
    await request().get('/phone/search?text=Number&limit=4&logs=a,d,t')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
  ...
  test(`Testing ${getCounter()} - Method /phone/search (SEARCH) [phone.search]`, async () => {
    await request().get('/phone/search?text=Number 01')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
          expect(response.body.paging.count).toBeDefined();
  ...
  test(`Testing ${getCounter()} - Method /phone/search (SEARCH) [phone.search]`, async () => {
    await request().get('/phone/search?text=01&logs=c,d,t')
      .then((response) => {
        if (response.statusCode === 200) {
          expect(response.body).toBeDefined();
          expect(response.body.paging.count).toBeDefined();
