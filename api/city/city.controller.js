  ...
  City.findById(req.params.id)
    .then((responseCity) => {
      return Country.findOne({
        'iso.code': responseCity.geometry.country_code,
      })
        .then((responseCountry) => {
          return State.findOne({
            code: responseCity.geometry.state_code,
          })
            .then((responseState) => {
              const address = `${responseCity.name}, ${responseState.name}, ${responseCountry.name}`;
  ...
  City.findById(req.params.id)
    .then((responseFind) => {
      ...
      return Neighborhood.find({
        'geometry.city_code': responseFind.code,
      }, 'code name')
